...
RUN apt-get update && \
    ...
    openssl req -x509 -nodes -newkey rsa:2048 -keyout ~/novnc.pem -out ~/novnc.pem -days 3650 -subj "/C=US/ST=NY/L=NY/O=NY/OU=NY/CN=NY emailAddress=nitesh.paudel@benekiva.com"

EXPOSE 80

CMD /opt/TurboVNC/bin/vncserver -geometry 1280x800 -depth 24 && \
